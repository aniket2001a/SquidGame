...
renderer.setClearColor( 0x79EAF2, 1 )  // change sky color
...
const shoot = new Audio('./music/shoot.mp3')
const endshoot = new Audio('./music/endshoot.mp3')
...
function start(){
    gameStat = "started"
    const progressBar = createCube({w: 8, h: .1, d: 1}, 0, 0, 0xcefaa7) // progress bar
